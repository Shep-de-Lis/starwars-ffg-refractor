if (typeof CONFIG !== "undefined" && CONFIG.FFG && !CONFIG.STYLE) {
  CONFIG.STYLE = {
    icons: {
...
export class DicePoolFFG {
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.proficiency ?? CONFIG.FFG.PROFICIENCY_ICON,
    this.proficiency,
    height,
    width
  );
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.ability ?? CONFIG.FFG.ABILITY_ICON,
    this.ability,
    height,
    width
  );
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.challenge ?? CONFIG.FFG.CHALLENGE_ICON,
    this.challenge,
    height,
    width
  );
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.difficulty ?? CONFIG.FFG.DIFFICULTY_ICON,
    this.difficulty,
    height,
    width
  );
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.boost ?? CONFIG.FFG.BOOST_ICON,
    this.boost,
    height,
    width
  );
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.setback ?? CONFIG.FFG.SETBACK_ICON,
    this.setback,
    height,
    width
  );
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.removeSetback ?? CONFIG.FFG.REMOVESETBACK_ICON,
    this.remsetback,
    height,
    width
  );
  ...
  this._addIcons(
    container,
    CONFIG?.STYLE?.icons?.force ?? CONFIG.FFG.FORCE_ICON,
    this.force,
    height,
    width
  );
